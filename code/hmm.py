...
class HMM:
    def get_transition_matrix(self):
        ...
        raise NotImplementedError('get_transition_matrix() must be overloaded in derived classes')

    def get_observation_matrix(self):
        """ Return the observations matrix """
        raise NotImplementedError('get_observation_matrix() must be overloaded in derived classes')
